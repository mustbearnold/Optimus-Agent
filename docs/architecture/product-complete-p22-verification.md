...
Planes: **program P22** · architecture hold (Security / Durability / Domain) ·
ledger `files.mutate`, `projects.scope`
...
**program P22 core exit: PASS** with concurrent-lease residual owned.
Next: program P23 (coordinated browser) or concurrent-lease hardening.
