...
use optimus_host::{chat_approval_resolve_cancellable, chat_turn_cancellable, handle_ipc};
...
impl TuiSession {
    ...
    fn approval_params(&self, decision: &str) -> Result<serde_json::Value, String> {
        let binding = self
            .pending_approval
            .as_ref()
...
fn resolved_update(value: &serde_json::Value) -> TurnUpdate {
...
#[cfg(test)]
pub(crate) fn approval_binding_fixture() -> Box<ToolApprovalBinding> {
    Box::new(
