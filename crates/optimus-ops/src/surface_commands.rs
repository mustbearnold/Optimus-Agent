...
pub fn builtin_surface_commands() -> Vec<SurfaceCommand> {
    vec![
        cmd(
            "help",
            "help",
            "Show available surface commands",
            CommandSurface::Both,
            None,
        ),
        cmd(
