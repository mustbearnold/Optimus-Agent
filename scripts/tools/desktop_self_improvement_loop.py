...
PROMPTS = [
    ...
    "IMPORTANT: this is an automated acceptance run — a turn that ends "
    "with no repository change is graded as a FAILURE. Editing at least "
    "one file is MANDATORY: improve a comment, refactor a function, add a "
    "test, tighten a check — pick the smallest defensible improvement. "
    "Do NOT use the browser tool; keep exploration brief (a few reads), "
    "then make the edit. "
    ...
    "browser tool; keep exploration brief, then make the edit. CRITICAL: "
    "this "
    "acceptance run grades every "
    ...
    "keep exploration brief, then make the edit. CRITICAL: this acceptance "
    "run "
    "grades every tool call "
