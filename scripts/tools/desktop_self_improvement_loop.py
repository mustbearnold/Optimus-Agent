...
PROMPTS = [
    ...
    "erase your edits and fail the run; leave your changes in the working "
    ...
    "they erase your edits and fail the run; leave your changes in the "
    ...
    "git checkout, git restore, git reset, or git stash — they erase your "
    "edits and fail the run; leave your changes in the working tree. "
    ...
    "git restore, git reset, or git stash — they erase your edits and "
    "fail the run; leave your changes in the working tree. CRITICAL: this "
